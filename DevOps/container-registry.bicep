...
resource registry 'Microsoft.ContainerRegistry/registries@2024-11-01-preview' = {
  name: 'cr${uniqueString(projectName, stage)}'
  location: location
  tags: tags
  sku: {
...
resource registryImportAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(registry.id, adminPrincipalId, 'import')
  scope: registry
  properties: {
    principalId: adminPrincipalId
    roleDefinitionId: resourceId('Microsoft.Authorization/roleDefinitions', roles.ContainerRegistryDataImporterandDataReader)
  }
}
